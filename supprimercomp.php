...
if(!empty($_POST)){
    ...
    $requete = $bd->prepare('DELETE  FROM competences WHERE id_competences = ?');
...
<meta charset="UTF-8">
    ...
    <title>Supprimer Competences </title>
    ...
    <body>
            ...
            <h1 style="text-align:center;">Supprimer Competences</h1>
                        ...
                        <tr>
                            <td>
                                ...
                                <form class="form" role="form" action="" method="POST" class="row g-3" enctype="multipart/form-data">
                                    ...
                                    <a class="btn btn-default" href="affichecomp.php">Non</a>
                                    </div>
