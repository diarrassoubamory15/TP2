...
if(!empty($_POST)){
    ...
    $requete = $bd->prepare('DELETE  FROM experiences WHERE id_experiences = ?');
...
<meta charset="UTF-8">
    ...
    <title>Supprimer experience </title>
    ...
    <body>
            ...
            <h1 style="text-align:center;">Supprimer Experiences</h1>
                        ...
                        <tr>
                            <td>
                                ...
                                <form class="form" role="form" action="" method="POST" class="row g-3" enctype="multipart/form-data">
                                    ...
                                    <a class="btn btn-default" href="afficheexp.php">Non</a>
                                    </div>
