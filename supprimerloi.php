...
if(!empty($_POST)){
    ...
    $requete = $bd->prepare('DELETE  FROM loisirs WHERE id_loisirs = ?');
...
<meta charset="UTF-8">
    ...
    <body>
            ...
            <h1 style="text-align:center;">Supprimer Loisir</h1>
                        ...
                        <tr>
                            <td>
                                ...
                                <form class="form" role="form" action="" method="POST" class="row g-3" enctype="multipart/form-data">
                                    ...
                                    <a class="btn btn-default" href="afficheloi.php">Non</a>
                                    </div>
